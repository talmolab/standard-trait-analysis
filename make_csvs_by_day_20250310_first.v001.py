...
def _(logging):
    ...
    STEP_NAME = "make_csvs"  # unique per notebook
    return TRAITS_CSV_PATH, EXPERIMENT_EXCEL_PATH, LOGGING_LEVEL, STEP_NAME


@app.cell
def _(OmegaConf, Path, setup_step_logger, STEP_NAME, LOGGING_LEVEL):
    # Load and resolve the config passed as a file path
    cfg = OmegaConf.load("config.yaml")  # Overwritten for each run
